...
// main("what is the weather of sydney?");
main(
  "What is weather of sydney, Delhi, Goa and then write the output this on a beautifuyll webpage. create a new folder saying weather and create all HTML CSS file there and then run this on my browser",
);
